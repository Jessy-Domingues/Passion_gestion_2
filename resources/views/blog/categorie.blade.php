<x-app-layout>
    ...
    <div class="mt-14 lg:-mx-6 lg:flex lg:items-start">
            <img class="object-cover lg:mx-6 lg:w-1/3 max-w-[30%] rounded-xl h-72  drop-shadow-[5px_5px_20px_rgba(0,0,0,0.25)] lg:h-80" src="{{ asset('/storage/' . $article->image) }}"alt="photo article">
