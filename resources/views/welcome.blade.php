    ...
    <body class="font-Karla bg-gray-100">
        <div class="min-h-screen bg-gray-100">
            ...
            <section class="h-full bg-gradient-to-b from-neutral-700 via-gray-200 to-black">
                <div class="w-full h-full flex items-center flex-col justify-center bg-cover bg-[center_bottom_-8rem] " style="background-image: url('{{ asset('img/CS_2.png') }}');">     
        ...
        <!-- Première section -->
    <section class="mt-10">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto my-4 md:max-lg:text-center lg:gap-8 xl:gap-0 lg:py-16 md:grid-cols-6 lg:grid-cols-12">
            <div class="mr-auto place-self-center md:col-span-7 lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold text-neutral-700 leading-none md:text-5xl xl:text-6xl">Bienvenue sur notre site dédié aux jeux vidéo de gestion !</h1>
            ...
            <a href="{{ route('blog.index') }}" class="col-start-2 lg:col-span-2 md:col-span-2 md:col-start-2 font-bold text-neutral-800 bg-orange-500/90 border border-orange-500 transition duration-300 hover:bg-transparent focus:ring-4 rounded-lg text-sm text-center px-2.5 py-2.5">
        ...
        <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            ...
            <div class="grid gap-8 text-gray-500 pb-5 sm:gap-12 md:grid-cols-3 lg:grid-cols-3 dark:text-gray-400">
                <p class="text-lg text-center">Base de joueurs mondiale estimée à plus de:<br>
                 <span class="text-orange-500">1,5 milliard de personnes.</span></p>
                 
                 <p class="text-lg text-center">Cities: Skylines, l'un des jeux de gestion les plus populaires:<br>
                 <span class="text-orange-500">7 millions de ventes depuis sa sortie en 2015.</span></p>
                 ...
                 <span class="text-orange-500">plus de 33 millions de ventes depuis ses débuts en 1992.</span></p>
            </div>
            <div class="w-4/6 py-5 m-auto text-gray-500 dark:text-gray-400">
    ...
    <footer class="p-4 sm:p-6 bg-gray-200/75 bg-gradient-to-t from-gray-500/25 via-gray-300/50 to-gray-100">
        <div class="mx-auto max-w-screen-xl">
            <div class="md:flex md:justify-between md:flex-row flex flex-col justify-center">
                ...
                <a href="{{ route('home') }}">
                    <img class="h-[60%] w-auto m-auto" src="../img/Logorange2.png" alt="Logo">
                </a>
                </div>
